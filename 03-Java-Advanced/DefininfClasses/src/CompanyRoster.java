...
public class CompanyRoster {
    public static void main(String[] args) {
        ...
        Map<String, Department> departaments = new HashMap<>();
        ...
        while (n-- > 0 ){
            ...
            departaments.putIfAbsent(department, new Department(department));
            departaments.get(department).getEmployees().add(employee);

            }

        Department maxDepartment = departaments
                .entrySet()
                .stream()
